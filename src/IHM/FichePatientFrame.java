...
public class FichePatientFrame extends JFrame implements ActionListener{
    ...
    public FichePatientFrame()
    {
        ...
        centerRightPanel.setLayout(new GridLayout(10,5,5,5));
        centerCenterPanel.setLayout(new GridLayout(10,2,5,5));
        ...
        // Creation des Labels
        titleLbl = new CustomJLabel("Créer une fiche patient.",new Color(38, 52, 50),new Font("Montserrat", 1, 18));
    	...
    	photoBtn = new CustomButton(new ImageIcon("FichePatientUI\\photo.png"));
    	femBtn = new CustomButton(new ImageIcon("FichePatientUI\\femBtn.png"));
    	maleBtn = new CustomButton(new ImageIcon("FichePatientUI\\malBtn.png"));
    	agendaBtn = new CustomButton(new ImageIcon("FichePatientUI\\agendaBtn.png"));
    	mailsBtn = new CustomButton(new ImageIcon("FichePatientUI\\mailsBtn.png"));
    	carteVitaleBtn = new CustomButton(new ImageIcon("FichePatientUI\\carteVitaleBtn.png"));
    	courrielBtn = new CustomButton(new ImageIcon("FichePatientUI\\courrielBtn.png"));
    	cerfacilBtn = new CustomButton(new ImageIcon("FichePatientUI\\cerfaCILBtn.png"));
    	phoneBtn = new CustomButton(new ImageIcon("FichePatientUI\\phoneBtn.png"));
    	uploadBtn = new CustomButton(new ImageIcon("FichePatientUI\\uploadBtn.png"));
    	mtBtn = new CustomButton(new ImageIcon("FichePatientUI\\mtBtn.png"));
    	longueDureeBtn = new CustomButton(new ImageIcon("FichePatientUI\\ldBtn.png"));
    	saveBtn = new CustomButton(new ImageIcon("FichePatientUI\\saveBtn.png"));
    ...
    private void ajouterPatient()
    {
    	...
    	Patient patient = new Patient(nomFamilleTxt.getText(), prenomTxt.getText(), nomJFTxt.getText(), dateNaissance, ageTxt.getText(), numImmTxt.getText(),
